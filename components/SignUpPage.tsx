      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <button
              type="submit"
              className="w-full px-4 py-2 text-lg font-semibold text-white bg-primary rounded-md shadow-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 mt-4"
            >
              Sign Up
            </button>
          </div>
